...
export const projects: Project[] = [
  ...
  },
  {
    ...
    does: 'KAIROS Lab collects pixel art, orbital layouts, motion studies, and small interface experiments around the Freddie K. visual system.',
  ...
  {
    index: '05',
    slug: 'facebook-ai-ops',
    title: 'FACEBOOK AI OPS',
    label: 'posts + messenger drafts',
    category: 'SOCIAL AUTOMATION LAB',
    date: '2026-05-09',
    publisher: 'Freddie K.',
    summary: 'A social automation concept for turning page updates and Messenger questions into cleaner drafts before a human approves them.',
    problem: 'Small businesses need steady Facebook content and quick replies, but raw automation can sound stiff, miss context, or answer too confidently.',
    does: 'Facebook AI Ops drafts post ideas, tidies Messenger replies with a humanizer pass, and keeps the final publish step in human hands.',
    stack: ['Meta webhooks', 'n8n workflows', 'draft queues', 'humanizer copy pass', 'approval gates'],
    status: 'concept lab',
    nextStep: 'Shape it into a simple product demo: draft, review, approve, publish.',
    command: 'facebook-ai-ops preview',
    output: ['post ideas drafted', 'messenger replies cleaned up', 'approval queue ready'],
    metrics: [
      { name: 'MODE', value: 'DEMO' },
      { name: 'SIGNAL', value: 'SOCIAL' },
